...
public class EventFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.mfragment_event, container, false);

        RecyclerView recyclerView = (RecyclerView) view.findViewById(R.id.event_recyclerview);
        LinearLayoutManager linearLayoutManager = new LinearLayoutManager(this.getActivity());
        recyclerView.setLayoutManager(linearLayoutManager);
        recyclerView.setHasFixedSize(true);
        ref = new Firebase("https://revaalumni-3e332.firebaseio.com/approved_events");
        ...
        adapter = new FirebaseRecyclerAdapter<Event, EventViewHolder>(Event.class, R.layout.card_layout, EventViewHolder.class, ref) {
            ...
            protected void populateViewHolder(EventViewHolder eventViewHolder, Event event, int i) {
                ...
                eventViewHolder.card_key.setText(event.getKey());
            }
        };
    ...
    public static class EventViewHolder extends RecyclerView.ViewHolder {
        public TextView card_date_box, card_desc, card_title,card_key;
        public String str;
        ...
        public EventViewHolder(View view) {
            ...
            card_key = (TextView) view.findViewById(R.id.card_key);
        }
